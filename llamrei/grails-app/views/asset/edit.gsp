...
<head>
    ...
    <div >
        ...
        <div class="body">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: assetInstance, field: 'imageurl', 'errors')}">
                                    <g:textField name="imageurl" value="${assetInstance?.assetName}" />
                                </td>
                            </tr>
            ...
            <g:form controller="asset" style= 'display: inline' action="delete" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" params="[id:assetInstance.id]"><button value='Delete Asset' class="buttonClass1">Remove</button></g:form>
