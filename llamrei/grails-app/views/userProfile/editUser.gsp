...
<div >
    ...
    <div style="margin-left: 20px;font-size: 20px;border:1px solid">
        ...
        <g:form controller="userProfile"  style= 'display: inline' action="remove" params="[id:userInstance.id]"><button value='Delete User' onclick=" return confirm('Are you sure you want to delete this user?');" id='deleteButton' class="buttonClass1" >Delete</button></g:form>
