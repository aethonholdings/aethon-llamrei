...
<div class="body">
    ...
    <div class="buttons">
        <g:form>
            ...
            <span class="actionButton"><g:actionSubmit class="editAsset" action="edit" value="${message(code: 'default.button.edit.label', default: 'Edit')}" /></span>
            <span class="actionButton"><g:actionSubmit class="deleteAsset" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" /></span>
        </g:form>
    </div>
</div>
</body>
